...
IF (LCase(currAct)="edit" OR currCopy="Yes") THEN
	...
	IF NOT getRs.eof THEN
		...
		IF (currWebPrice<=0) THEN
			...
			disabledMarginPct = "disabled"
			disabledMarginValue = "disabled"
					...
					<td rowspan="2" width="50%" valign="top"  style="border:1px solid <%=xWarnaLine%>">
						<table width="100%">
                            ...
                            <tr height="25">
								...
								<td class="wordfield">
									<input id="crShipWeight" name="crShipWeight" type="text" size="4" maxlength="4" class="wordfieldnormalmust" value="<%=currShipWeight%>" accesskey="w" onKeyPress="return gjs_bilangan(event.KeyCode)" style="text-align:right" />&nbsp;Kg
								</td>
								<td valign="bottom">&nbsp;</td>
							</tr>
                            <tr height="25">
					...
					<td width="100%" valign="top" style="border: 1px solid <%=xWarnaLine%>">
						<table width="100%" >
                                	...
                                	<table class="wordfield">
                                    	<tr>
                                    		...
                                    		<td>
                                    			...
                                    			<input id="hidVPLPrice" name="hidVPLPrice" type="hidden" class="wordfieldnormal" value="<%=FormatNumberCustom(currVPLPrice,4)%>" style="text-align:right" size="20" maxlength="15" readonly />
												<input id="hidVPLPriceID" name="hidVPLPriceID" type="hidden" class="wordfieldnormal" value="<%=currVPLPriceID%>" size="5" maxlength="5" readonly />
                                            </td>
                                    	</tr>
                                    </table>
                                </td>
							...
							<tr height="25">
                                ...
                                <td class="wordfield">
                                    <input id="crVPLPriceTax" name="crVPLPriceTax" type="text" class="wordfieldnormalmust" value="<%=FormatNumber(currVPLPriceTax,2)%>" accesskey="i" onKeyPress="return gjs_bilangan(event.KeyCode)" style="text-align:right" onChange="fjs_updateVPLPriceTax();fjs_setlastupdateprcVPL();" size="20" maxlength="15" />
                                    <input id="hidVPLPriceTax" name="hidVPLPriceTax" type="hidden" class="wordfieldnormal" value="<%=FormatNumberCustom(currVPLPriceTax,4)%>" style="text-align:right" size="20" maxlength="15" readonly />
                                </td>
								<td valign="bottom">&nbsp;</td>
							</tr>
                            <tr height="25">
								...
								<td class="wordfield">
									<input id="radInclude" name="radPPN" type="radio" value="1" onClick="fjs_marginValue();fjs_setlastupdateWebPrice();" <%=rbPPNInclude%> <%''=disabledInclude%>/><span style="width:30%">Include</span>
                                    <input id="radExclude" name="radPPN" type="radio" value="0" onClick="fjs_marginValue();fjs_setlastupdateWebPrice();" <%=rbPPNExclude%> <%''=disabledExclude%>/><span style="width:40%">Exclude</span>
                                </td>
								<td valign="bottom">&nbsp;</td>
							</tr>
                            <tr height="25">
							...
							<tr height="25">
								...
								<td class="wordfield">
									<input id="crMarginPct" name="crMarginPct" type="text" class="wordfieldnormalmust" style="text-align:right" value="<%=currMarginPct%>" onChange="fjs_marginPct();fjs_setlastupdateWebPrice();" onKeyPress="return gjs_bilangan(event.KeyCode)" size="5" maxlength="5" <%=disabledMarginPct%> /><span style="width:24%">Percentage(%)</span>
                                    ...
                                    <table>
                                    	<tr>
                                            ...
                                            <td class="wordfield">	
                                                ...
                                                <input id="hidWebPrice" name="hidWebPrice" type="hidden" class="wordfieldnormal" value="<%=FormatNumberCustom(currWebPrice,4)%>" size="20" style="text-align:right" maxlength="15" readonly />
                                                <input id="hidWebPriceID" name="hidWebPriceID" type="hidden" class="wordfieldnormal" value="<%=currWebPriceID%>" size="5" maxlength="5" readonly />
                                            </td>
                                      	</tr>
                              		</table>
								</td>
                            ...
                            <tr height="25">
								...
								<td class="wordfield">	
									...
									<input id="hidWebPriceTax" name="hidWebPriceTax" type="hidden" class="wordfieldnormal" value="<%=FormatNumberCustom(currWebPriceTax,4)%>" style="text-align:right" size="20" maxlength="15" readonly />
                                </td>
								<td valign="bottom">&nbsp;</td>
							</tr>
							<tr height="25">
...
function fjs_VPLPriceID(num){
	...
	if (bool){
		objHidVPLPrice.value = tempValue.toFixed(4);
		objHidVPLPriceTax.value = (tempValue*1.1).toFixed(4);
...
function fjs_WebPriceID(num){
	...
	if(bool){
		objHidWebPrice.value = tempValue.toFixed(4);
		objHidWebPriceTax.value = (tempValue*1.1).toFixed(4);
		objWebPrice.value = tempValue.format(2,3,',','.');
		if(objHidWebPriceID.value=='CUR01'){
			if(objPPN[0].checked){
				objHidWebPriceTax.value = ((parseFloat(tempValue)*1.1)).toFixed(4);
				if((parseFloat(objHidWebPriceTax.value)%1)>0){
					...
					if((parseFloat(fjs_cekMoney(objWebPriceTax.value))%100)>0){
						tempValue = ((((tempValue.toFixed(4))*1.1)-0.5)/1.1).toFixed(4);
						objHidWebPrice.value = parseFloat(tempValue).toFixed(4);
				...
				objHidWebPriceTax.value = (parseFloat(tempValue)).toFixed(4);	
			}
		}else{
			if(objPPN[0].checked){
...
function fjs_updateVPLPriceTax(){
	...
	objVPLPriceTax.value = tempValueTax.format(2,3,',','.');
	objHidVPLPriceTax.value = tempValueTax.toFixed(4);
	objVPLPrice.value = (tempValueTax/1.1).format(2,3,',','.');
	objHidVPLPrice.value = (tempValueTax/1.1).toFixed(4);
...
function fjs_updateWebPriceTax(){
	...
	objHidWebPriceTax.value = parseFloat(tempWebPriceTax).toFixed(4);
	...
	if(tempWebPriceTax>tempVPLPrice){
		...
		objHidWebPrice.value = (tempVPLPrice+marginValue).toFixed(4);
	}
}
function fjs_cekVPL(){
	var objHidVPLPriceTax;
...
//	fjs_marginValue();
	...
	/*if(parseFloat(objHidWebPrice.value)>0){
		if(num==1){
			objHidWebPriceTax.value = parseFloat(objHidWebPrice.value*1.1).toFixed(4);
			objWebPriceTax.value = parseFloat(objHidWebPrice.value*1.1).format(2,3,',','.');	
		}else{
			objHidWebPriceTax.value = parseFloat(objHidWebPrice.value).toFixed(4);
...
function fjs_Call(objCall){
	...
	if (objCall.checked==true){
		//objPPN[0].checked = true;
		objMarginPct.value = 0;
		objMarginValue.value = 0;
		objWebPriceID[0].checked = true;
		objHidWebPriceID.value =  'CUR01';
		objWebPrice.value = -1;
...
function fjs_OOS(objOOS){
	...
	if (objOOS.checked==true){
		...
		objHidWebPriceID.value =  'CUR01';
		objWebPrice.value = 0;
		objHidWebPrice.value = 0;
		objWebPriceTax.value = 0;
		objHidWebPriceTax.value = 0;
		objSPriceID[0].checked = true;
		objHidSPriceID.value =  'CUR01';
		objSPrice.value = 0;
		objHidSPrice.value = 0;
...
function fjs_marginPct(){
	...
	bool = fjs_cekVPL();
	if(bool==1){
		if(objMarginPct.value!=''){
			marginPct = parseFloat(fjs_cekMoney(objMarginPct.value));
			objMarginValue.value = parseFloat((marginPct/100)*parseFloat(objHidVPLPrice.value)).format(2,3,',','.');
			fjs_marginValue();
		}else{
...
function fjs_marginValue(){
	...
	if(bool==1){
		if(objMarginValue.value!=''){
			...
			objHidWebPrice.value = (tempValue+marginValue).toFixed(4);
			if(objHidWebPriceID.value=='CUR01'){
				if(objPPN[0].checked){
					/*objHidVPLPriceTax.value = ((parseFloat(objHidVPLPrice.value)*1.1)).toFixed(4);
...
function fjs_SPriceID(num){
	...
	if(bool){
		objHidSPrice.value = tempValue.toFixed(4);
		objHidSPriceTax.value = (tempValue*1.1).toFixed(4);
		objSPrice.value = tempValue.format(2,3,',','.');
		if(objHidSPriceID.value=='CUR01'){
			objHidSPriceTax.value = ((parseFloat(tempValue)*1.1)).toFixed(4);
			if((parseFloat(objHidSPriceTax.value)%1)>0){
				...
				if((parseFloat(fjs_cekMoney(objSPriceTax.value))%100)>0){
					tempValue = ((((tempValue.toFixed(4))*1.1)-0.5)/1.1).toFixed(4);
					objHidSPrice.value = parseFloat(tempValue).toFixed(4);
...
function fjs_updateSPriceTax(){
	...
	if(tempValue>0){
		objHidSPriceTax.value = tempValue.toFixed(4);
		objHidSPrice.value = (tempValue/1.1).toFixed(4);
		if(objHidSPriceID.value=='CUR01'){
			//alert('OK');
			tempSPriceTax = ((parseFloat(objHidSPrice.value)*1.1)+0.5).toFixed(4);
			//alert(tempSPriceTax);
			//alert(tempSPriceTax);
			if(tempSPriceTax>parseFloat(objHidSPriceTax.value)){
				objHidSPrice.value = (((parseFloat(objHidSPrice.value)*1.1)-0.5)/1.1).toFixed(4);
